...
```bash
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase probe --name p36_probe10_extrapolated_low --max-steps 12000
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase d4 --name d4_sparse035 --max-steps 12000
```
...
```bash
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase probe --name p36_probe10_extrapolated_low --max-steps 12000
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase probe --name p46_probe10_relaxed_phase_supply --max-steps 12000
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase d4 --name d4_sparse035 --max-steps 12000
```
...
```bash
/Users/bytedance/miniconda3/bin/python -m unittest tests.test_controller_reacquire tests.test_viz_progress
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase probe --name p36_probe10_extrapolated_low --max-steps 12000
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase probe --name p47_probe10_magnetic_crossing_control --max-steps 12000
```
...
```bash
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase probe --name p36_probe10_extrapolated_low --max-steps 12000
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase d2 --name d2_shadow_axis_selector --max-steps 12000
```
...
```bash
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase d2 --name d2_shadow_axis_selector --max-steps 12000
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase d3 --name d3_shadow_axis_selector_age45 --max-steps 12000
```
...
```bash
/Users/bytedance/miniconda3/bin/python tools/evaluate_dropout_variants.py --phase d3 --name d3_shadow_axis_dual_gate_shadow --max-steps 12000
```
