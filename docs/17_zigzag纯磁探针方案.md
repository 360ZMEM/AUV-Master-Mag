...
| variant | max steps | health | TRACK XT | TRACK vehicle err | route | final dist | lookahead coverage | lookahead pos err | 结论 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `p25_probe10_feedlocal_gate60` | 12000 | 25.3 | 7.7m | 41.2° | 37.0% | 31.1m | 41.6% | 17.7m | 门控后短测仍保留 p22 的推进能力。 |
| `p26_probe10_feedlocal_gate90` | 12000 | 25.2 | 7.7m | 41.2° | 37.1% | 39.0m | 41.6% | 17.7m | 放宽 phase/age 与 p25 类似。 |
| `p25_probe10_feedlocal_gate60` | 24000 | 14.5 | 27.0m | 138.8° | 37.6% | 16.2m | 34.7% | 14.1m | 相比未门控 p22 长测回退到 0%，门控能维持推进，但航向仍不可靠。 |
| `p26_probe10_feedlocal_gate90` | 24000 | 20.0 | 24.1m | 69.1° | 39.6% | 15.8m | 38.0% | 25.5m | route 略高，但 lookahead 位置误差更大。 |
| `p27_probe10_gate60_nopursuit` | 24000 | 14.5 | 27.0m | 138.8° | 37.6% | 16.2m | 34.7% | 14.1m | 与 p25 一致，pure-pursuit 不是航向误差来源。 |
| `p28_probe10_gate45_conservative` | 24000 | 43.9 | 8.2m | 63.9° | 9.0% | 0.9m | 20.2% | 3.6m | 保守门控估计最干净，但供给不足，route 低。 |
| `p29_probe10_gate60_mid` | 24000 | 17.0 | 7.7m | 41.2° | 0.0% | 58.7m | 20.8% | 17.7m | 中间门控未形成有效推进。 |
| `p30_probe10_gate75_mid` | 24000 | 17.0 | 7.7m | 41.2° | 0.0% | 58.7m | 20.8% | 17.7m | 与 p29 一致。 |
