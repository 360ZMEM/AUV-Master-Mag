...
_NUMERIC_CHANNELS = (
    ...
    "map_frame_projection_enabled",
    "map_frame_progress_m",
    "map_frame_lateral_m",
    "map_frame_projection_distance_m",
    "map_frame_consistency_score",
    "map_frame_projection_untrusted",
    "prior_alignment_enabled",
    "prior_alignment_accepted",
    "prior_alignment_reason_code",
    "prior_alignment_residual_m",
    "prior_alignment_residual_x_m",
    "prior_alignment_residual_y_m",
    "prior_alignment_step_m",
    "prior_alignment_step_x_m",
    "prior_alignment_step_y_m",
    "prior_alignment_translation_x_m",
    "prior_alignment_translation_y_m",
    "prior_alignment_rotation_deg",
    "prior_alignment_heading_residual_deg",
    "prior_alignment_confidence",
    "prior_alignment_progress_m",
    "zigzag_probe_active",
...
def simulate_run(
    ...
    for step_index in range(total_steps):
        ...
        recorder.append(
            ...
            shadow_axis_hypothesis_valid=1.0 if perception.shadow_axis_hypothesis_valid else 0.0,
            shadow_axis_hypothesis_count=float(perception.shadow_axis_hypothesis_count),
            ...
            shadow_axis_target_y_m=(
                np.nan if perception.shadow_axis_target_xy_m is None else perception.shadow_axis_target_xy_m[1]
            ),
            shadow_axis_heading_deg=_optional(perception.shadow_axis_heading_deg),
            shadow_axis_age_s=perception.shadow_axis_age_s,
            shadow_axis_validation_passed=1.0 if perception.shadow_axis_validation_passed else 0.0,
            shadow_axis_validation_reason_code=perception.shadow_axis_validation_reason_code,
            shadow_axis_validation_score_deficit=perception.shadow_axis_validation_score_deficit,
            shadow_axis_validation_margin_deficit=perception.shadow_axis_validation_margin_deficit,
            shadow_axis_validation_age_over_s=perception.shadow_axis_validation_age_over_s,
            ...
            map_frame_projection_enabled=1.0 if perception.map_frame_projection_enabled else 0.0,
            map_frame_progress_m=perception.map_frame_progress_m,
            map_frame_lateral_m=perception.map_frame_lateral_m,
            map_frame_projection_distance_m=perception.map_frame_projection_distance_m,
            map_frame_consistency_score=perception.map_frame_consistency_score,
            map_frame_projection_untrusted=1.0 if perception.map_frame_projection_untrusted else 0.0,
            prior_alignment_enabled=1.0 if perception.prior_alignment_enabled else 0.0,
            prior_alignment_accepted=1.0 if perception.prior_alignment_accepted else 0.0,
            prior_alignment_reason_code=perception.prior_alignment_reason_code,
            prior_alignment_residual_m=perception.prior_alignment_residual_m,
            prior_alignment_residual_x_m=perception.prior_alignment_residual_x_m,
            prior_alignment_residual_y_m=perception.prior_alignment_residual_y_m,
            prior_alignment_step_m=perception.prior_alignment_step_m,
            prior_alignment_step_x_m=perception.prior_alignment_step_x_m,
            prior_alignment_step_y_m=perception.prior_alignment_step_y_m,
            prior_alignment_translation_x_m=perception.prior_alignment_translation_x_m,
            prior_alignment_translation_y_m=perception.prior_alignment_translation_y_m,
            prior_alignment_rotation_deg=perception.prior_alignment_rotation_deg,
            prior_alignment_heading_residual_deg=perception.prior_alignment_heading_residual_deg,
            prior_alignment_confidence=perception.prior_alignment_confidence,
            prior_alignment_progress_m=perception.prior_alignment_progress_m,
