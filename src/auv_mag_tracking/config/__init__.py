...
class TrackingConfig:
    ...
    magnetic_shadow_progress_alignment_enabled: bool = False
    magnetic_shadow_progress_alignment_min_dot: float = 0.0
    magnetic_shadow_progress_alignment_min_confidence: float = 0.25
    magnetic_shadow_progress_alignment_max_age_s: float = 180.0
    magnetic_shadow_progress_proxy_hold_enabled: bool = False
    magnetic_shadow_route_bound_progress_proxy_enabled: bool = False
    magnetic_shadow_task_score_motion_weight: float = 0.65
    magnetic_shadow_task_score_progress_weight: float = 0.35
    magnetic_shadow_probe_forward_delta_min_m: float = 0.5
    magnetic_shadow_forward_zigzag_min_forward_dot: float = 0.35
    magnetic_shadow_forward_zigzag_min_lateral_dot: float = 0.10
    magnetic_shadow_decoupled_lateral_lookahead_m: float = 12.0
    decoupled_lateral_target_control_enabled: bool = False
    decoupled_lateral_target_control_blend: float = 1.0
    decoupled_lateral_target_control_max_correction_deg: float = 180.0
    decoupled_lateral_target_min_flip_interval_s: float = 0.0
    decoupled_lateral_probe_burst_enabled: bool = False
    decoupled_lateral_probe_burst_start_delay_s: float = 0.0
    decoupled_lateral_probe_burst_duration_s: float = 0.0
    decoupled_lateral_probe_recovery_duration_s: float = 0.0
    decoupled_lateral_probe_recovery_control_enabled: bool = False
    decoupled_lateral_probe_recovery_lookahead_m: float = 30.0
    decoupled_lateral_probe_route_governor_enabled: bool = False
    decoupled_lateral_probe_route_governor_min_delta_m: float = -0.2
    decoupled_lateral_probe_route_governor_lockout_s: float = 120.0
    probe_burst_manager_enabled: bool = False
    probe_burst_manager_idle_min_duration_s: float = 30.0
    probe_burst_manager_entry_min_route_delta_m: float = 3.0
    probe_burst_manager_entry_max_abs_cross_track_m: float = 80.0
    probe_burst_manager_burst_min_duration_s: float = 4.0
    probe_burst_manager_burst_max_duration_s: float = 12.0
    probe_burst_manager_burst_target_evidence_count: int = 1
    probe_burst_manager_recovery_min_duration_s: float = 20.0
    probe_burst_manager_recovery_target_route_delta_m: float = 8.0
    probe_burst_manager_recovery_max_abs_cross_track_m: float = 3.0
    probe_burst_manager_recovery_timeout_s: float = 120.0
    probe_burst_manager_cooldown_duration_s: float = 120.0
    probe_burst_manager_reacquire_safe_window_enabled: bool = False
    probe_burst_manager_reacquire_safe_max_abs_cross_track_m: float = 80.0
